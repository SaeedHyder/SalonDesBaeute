package com.app.salonbeaute.fragments.abstracts;
...
import com.app.salonbeaute.helpers.GPSTracker;
import com.app.salonbeaute.helpers.ServiceHelper;
import com.app.salonbeaute.helpers.UIHelper;
import com.app.salonbeaute.interfaces.LoadingListener;
...
public abstract class BaseFragment extends Fragment implements webServiceResponseLisener {
	...
	protected void setPinEntryFocus(EditText textFocus) {
		InputMethodManager imm = (InputMethodManager) getDockActivity().getSystemService(Context.INPUT_METHOD_SERVICE);
		if (imm != null)
			imm.showSoftInput(textFocus, InputMethodManager.SHOW_IMPLICIT);
	}
