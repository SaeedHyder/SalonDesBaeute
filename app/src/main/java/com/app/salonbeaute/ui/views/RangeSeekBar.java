...
package com.app.salonbeaute.ui.views;
...
public class RangeSeekBar<T extends Number> extends ImageView {
    ...
    private void init(Context context, AttributeSet attrs) {
        float barHeight;
        int thumbNormal = R.color.white;
        int thumbPressed = R.color.app_red_dark;
        int thumbDisabled = R.color.app_red_dark;
    ...
    protected synchronized void onDraw(@NonNull Canvas canvas) {
        ...
        if (showTextAboveThumbs && (activateOnDefaultValues || !selectedValuesAreDefault)) {
            ...
            String minText=unit+String.valueOf(minValue);
            String maxText= unit+String.valueOf(maxValue);
            /*if (minValue < 12) {
